...
public class ItemindexAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = LayoutInflater.from(mContect).inflate(R.layout.item_index_gridview,null);
        ...
        final IndexObj cell = lists.get(position);
        if(cell != null){
            holder.item_title.setText(cell.getTitle());
            holder.item_pic.setImageResource(cell.getId());
        }
        return convertView;
    }
    class ViewHolder {
